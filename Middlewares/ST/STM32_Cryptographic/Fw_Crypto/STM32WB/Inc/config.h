...
typedef struct
{
  uint8_t X;                   /*!< Used to get the X parametre of the current STM32 crypto library version */
  uint8_t Y;                   /*!< Used to get the Y parametre of the current STM32 crypto library version */
  uint8_t Z;                   /*!< Used to get the Z parametre of the current STM32 crypto library version */
  uint8_t Type;                /*!< Used to get the Type of the version. 
...
/** @defgroup CRYPTO_LIBRARY_VERSION
  ...
  * @{
  */   
#define VERSION_X 3 /*!< The X parametre of the current STM32 crypto library version */
#define VERSION_Y 0 /*!< The Y parametre of the current STM32 crypto library version */
#define VERSION_Z 0 /*!< The Z parametre of the current STM32 crypto library version */
/**
