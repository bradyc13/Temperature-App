...
class DeviceEnergyManagementCluster(
  ...
  sealed class PowerAdjustmentCapabilityAttributeSubscriptionState {
    ...
    object SubscriptionEstablished : PowerAdjustmentCapabilityAttributeSubscriptionState()
  }

  class ForecastAttribute(val value: DeviceEnergyManagementClusterForecastStruct?)

  sealed class ForecastAttributeSubscriptionState {
    data class Success(val value: DeviceEnergyManagementClusterForecastStruct?) :
      ForecastAttributeSubscriptionState()

    data class Error(val exception: Exception) : ForecastAttributeSubscriptionState()
  ...
  suspend fun cancelPowerAdjustRequest(timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun resumeRequest(timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun subscribeESATypeAttribute(
    minInterval: Int,
    maxInterval: Int
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Esatype attribute not found in Node State update" }
      ...
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Esacangenerate attribute not found in Node State update"
          }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Esastate attribute not found in Node State update" }
  ...
  suspend fun subscribeAbsMinPowerAttribute(
    minInterval: Int,
    maxInterval: Int
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Absminpower attribute not found in Node State update" }
  ...
  suspend fun subscribeAbsMaxPowerAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<LongSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 4u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Absmaxpower attribute not found in Node State update" }
  ...
  suspend fun subscribePowerAdjustmentCapabilityAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<PowerAdjustmentCapabilityAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 5u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            PowerAdjustmentCapabilityAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Poweradjustmentcapability attribute not found in Node State update"
          }
          ...
          decodedValue?.let {
            emit(PowerAdjustmentCapabilityAttributeSubscriptionState.Success(it))
          }
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(PowerAdjustmentCapabilityAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }
  }
  ...
  suspend fun subscribeForecastAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<ForecastAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 6u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            ForecastAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Forecast attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(ForecastAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
