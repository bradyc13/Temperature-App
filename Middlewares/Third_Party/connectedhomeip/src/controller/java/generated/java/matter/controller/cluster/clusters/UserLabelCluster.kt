...
class UserLabelCluster(private val controller: MatterController, private val endpointId: UShort) {
  ...
  sealed class LabelListAttributeSubscriptionState {
    data class Success(val value: List<UserLabelClusterLabelStruct>) :
  ...
  suspend fun readLabelListAttribute(): LabelListAttribute {
    ...
    val decodedValue: List<UserLabelClusterLabelStruct> =
      buildList<UserLabelClusterLabelStruct> {
        tlvReader.enterArray(AnonymousTag)
        while (!tlvReader.isEndOfContainer()) {
          add(UserLabelClusterLabelStruct.fromTlv(AnonymousTag, tlvReader))
        }
  ...
  companion object {
    private val logger = Logger.getLogger(UserLabelCluster::class.java.name)
