...
class DeviceEnergyManagementModeCluster(
  ...
  class SupportedModesAttribute(val value: List<DeviceEnergyManagementModeClusterModeOptionStruct>)

  sealed class SupportedModesAttributeSubscriptionState {
    data class Success(val value: List<DeviceEnergyManagementModeClusterModeOptionStruct>) :
  ...
  suspend fun readSupportedModesAttribute(): SupportedModesAttribute {
    ...
    val decodedValue: List<DeviceEnergyManagementModeClusterModeOptionStruct> =
      buildList<DeviceEnergyManagementModeClusterModeOptionStruct> {
  ...
  companion object {
    private val logger = Logger.getLogger(DeviceEnergyManagementModeCluster::class.java.name)
    const val CLUSTER_ID: UInt = 159u
  }
}
