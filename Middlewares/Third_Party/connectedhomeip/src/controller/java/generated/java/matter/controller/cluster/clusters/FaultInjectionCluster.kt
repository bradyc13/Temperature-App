...
class FaultInjectionCluster(
  ...
  suspend fun failAtFault(
    ...
    val TAG_TYPE_REQ: Int = 0
    tlvWriter.put(ContextSpecificTag(TAG_TYPE_REQ), type)

    val TAG_ID_REQ: Int = 1
    tlvWriter.put(ContextSpecificTag(TAG_ID_REQ), id)

    val TAG_NUM_CALLS_TO_SKIP_REQ: Int = 2
    tlvWriter.put(ContextSpecificTag(TAG_NUM_CALLS_TO_SKIP_REQ), numCallsToSkip)

    val TAG_NUM_CALLS_TO_FAIL_REQ: Int = 3
    tlvWriter.put(ContextSpecificTag(TAG_NUM_CALLS_TO_FAIL_REQ), numCallsToFail)
  ...
  suspend fun failRandomlyAtFault(
    ...
    val TAG_PERCENTAGE_REQ: Int = 2
    tlvWriter.put(ContextSpecificTag(TAG_PERCENTAGE_REQ), percentage)
    tlvWriter.endStructure()
  ...
  companion object {
    private val logger = Logger.getLogger(FaultInjectionCluster::class.java.name)
