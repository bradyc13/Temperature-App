...
class MicrowaveOvenModeCluster(
  ...
  sealed class SupportedModesAttributeSubscriptionState {
    data class Success(val value: List<MicrowaveOvenModeClusterModeOptionStruct>) :
  ...
  suspend fun readSupportedModesAttribute(): SupportedModesAttribute {
    ...
    val decodedValue: List<MicrowaveOvenModeClusterModeOptionStruct> =
      buildList<MicrowaveOvenModeClusterModeOptionStruct> {
