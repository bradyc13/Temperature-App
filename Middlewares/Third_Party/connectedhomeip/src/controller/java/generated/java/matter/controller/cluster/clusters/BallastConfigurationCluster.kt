...
class BallastConfigurationCluster(
  ...
  sealed class IntrinsicBallastFactorAttributeSubscriptionState {
    data class Success(val value: UByte?) : IntrinsicBallastFactorAttributeSubscriptionState()

    data class Error(val exception: Exception) : IntrinsicBallastFactorAttributeSubscriptionState()

    object SubscriptionEstablished : IntrinsicBallastFactorAttributeSubscriptionState()
  }

  class BallastFactorAdjustmentAttribute(val value: UByte?)

  sealed class BallastFactorAdjustmentAttributeSubscriptionState {
    data class Success(val value: UByte?) : BallastFactorAdjustmentAttributeSubscriptionState()

    data class Error(val exception: Exception) :
      BallastFactorAdjustmentAttributeSubscriptionState()

    object SubscriptionEstablished : BallastFactorAdjustmentAttributeSubscriptionState()
  }

  class LampRatedHoursAttribute(val value: UInt?)

  sealed class LampRatedHoursAttributeSubscriptionState {
    data class Success(val value: UInt?) : LampRatedHoursAttributeSubscriptionState()

    data class Error(val exception: Exception) : LampRatedHoursAttributeSubscriptionState()

    object SubscriptionEstablished : LampRatedHoursAttributeSubscriptionState()
  }

  class LampBurnHoursAttribute(val value: UInt?)

  sealed class LampBurnHoursAttributeSubscriptionState {
    data class Success(val value: UInt?) : LampBurnHoursAttributeSubscriptionState()

    data class Error(val exception: Exception) : LampBurnHoursAttributeSubscriptionState()

    object SubscriptionEstablished : LampBurnHoursAttributeSubscriptionState()
  }

  class LampBurnHoursTripPointAttribute(val value: UInt?)

  sealed class LampBurnHoursTripPointAttributeSubscriptionState {
    data class Success(val value: UInt?) : LampBurnHoursTripPointAttributeSubscriptionState()

    data class Error(val exception: Exception) : LampBurnHoursTripPointAttributeSubscriptionState()

    object SubscriptionEstablished : LampBurnHoursTripPointAttributeSubscriptionState()
  }
      ...
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Physicalminlevel attribute not found in Node State update"
          }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Physicalmaxlevel attribute not found in Node State update"
          }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Ballaststatus attribute not found in Node State update" }
  ...
  suspend fun writeMinLevelAttribute(value: UByte, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 16u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Minlevel attribute not found in Node State update" }
  ...
  suspend fun writeMaxLevelAttribute(value: UByte, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 17u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Maxlevel attribute not found in Node State update" }
  ...
  suspend fun subscribeIntrinsicBallastFactorAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<IntrinsicBallastFactorAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 20u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            IntrinsicBallastFactorAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Intrinsicballastfactor attribute not found in Node State update"
          }
          ...
          decodedValue?.let { emit(IntrinsicBallastFactorAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(IntrinsicBallastFactorAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }
  }
  ...
  suspend fun subscribeBallastFactorAdjustmentAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<BallastFactorAdjustmentAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 21u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            BallastFactorAdjustmentAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Ballastfactoradjustment attribute not found in Node State update"
          }
          ...
          decodedValue?.let { emit(BallastFactorAdjustmentAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(BallastFactorAdjustmentAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }
  }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Lampquantity attribute not found in Node State update" }
  ...
  suspend fun writeLampTypeAttribute(value: String, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 48u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Lamptype attribute not found in Node State update" }
  ...
  suspend fun writeLampManufacturerAttribute(value: String, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 49u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Lampmanufacturer attribute not found in Node State update"
          }
  ...
  suspend fun writeLampRatedHoursAttribute(value: UInt, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 50u
  ...
  suspend fun subscribeLampRatedHoursAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<LampRatedHoursAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 50u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            LampRatedHoursAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Lampratedhours attribute not found in Node State update"
          }
          ...
          decodedValue?.let { emit(LampRatedHoursAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(LampRatedHoursAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }
  }
  ...
  suspend fun writeLampBurnHoursAttribute(value: UInt, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 51u
  ...
  suspend fun subscribeLampBurnHoursAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<LampBurnHoursAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 51u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            LampBurnHoursAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Lampburnhours attribute not found in Node State update" }
          ...
          decodedValue?.let { emit(LampBurnHoursAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(LampBurnHoursAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }
  }
  ...
  suspend fun writeLampAlarmModeAttribute(value: UByte, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 52u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Lampalarmmode attribute not found in Node State update" }
  ...
  suspend fun subscribeLampBurnHoursTripPointAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<LampBurnHoursTripPointAttributeSubscriptionState> {
    val ATTRIBUTE_ID: UInt = 53u
    val attributePaths =
      listOf(
        AttributePath(endpointId = endpointId, clusterId = CLUSTER_ID, attributeId = ATTRIBUTE_ID)
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            LampBurnHoursTripPointAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Lampburnhourstrippoint attribute not found in Node State update"
          }
          ...
          decodedValue?.let { emit(LampBurnHoursTripPointAttributeSubscriptionState.Success(it)) }
        }
        SubscriptionState.SubscriptionEstablished -> {
          emit(LampBurnHoursTripPointAttributeSubscriptionState.SubscriptionEstablished)
        }
      }
    }
  }
